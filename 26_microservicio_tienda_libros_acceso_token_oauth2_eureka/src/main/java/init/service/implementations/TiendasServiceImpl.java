...
public class TiendasServiceImpl implements TiendasService {
	...
	@Autowired
	@Qualifier("ribbonClient")//anotación para inyectar por el nombre
	//varias instancias de un mismo tipo y queremos una en concreto
	RestClient restClientRibbon;
	
	@Autowired
	@Qualifier("noRibbonClient")//anotación para inyectar por el nombre
	...
	private List<Libro> libros(){
		return Arrays.asList(restClientRibbon.get()
				.uri(urlBase+"libros")
				.retrieve()
